...
namespace Guia10
{
    public partial class Vertice : Form
    {
        ...
        {
            //Trim() Metodo para eliminar los espacios en blancos dentro del textbox 
            string valor = txtVertice.Text.Trim();
       
            if ((valor=="") || (valor==" "))
            {
                MessageBox.Show("Debes ingresar un valor", "Error en valor nodo", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }

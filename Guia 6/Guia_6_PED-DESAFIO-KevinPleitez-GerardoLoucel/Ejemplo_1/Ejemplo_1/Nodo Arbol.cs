...
using System.Threading; //libreria para manejar los hilos
...
namespace Ejemplo_1
{
    class Nodo_Arbol
    {
        ...
        private Form1 arbol; //declarando un objeto de tipo árbol
        ...
        public void Eliminar(int x, ref Nodo_Arbol t)
        {
                    ...
                    else
                    {
                        ...
                        { //se verifica si tiene hijo izq
                            ...
                            else
                            {
                                ...
                                {
                                    Nodo_Arbol AuxiliarNodo = null; Nodo_Arbol Auxiliar = t.Izquierdo; bool bandera = false;
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        if (Alturas(t.Derecho) - Alturas(t.Izquierdo) == 0)
                                        {
                                            ...
                                            else { t.Izquierdo = Auxiliar.Izquierdo; }
                                        }
                                    }
                                }
                            }
            ...
            else { MessageBox.Show("Nodo NO existente el Arbol", "Error de eliminación"); }
        ...
        public void buscar(int x, Nodo_Arbol t)
        {
            ...
            else { MessageBox.Show("Nodo NO encontrado", "Error de búsqueda"); }
        }
        ...
        public void PosicionNodo(ref int xmin, int ymin) {
            ...
            if (Izquierdo != null && Derecho != null) CoordenadaX = (int)((Izquierdo.CoordenadaX + Derecho.CoordenadaX) / 2);
            ...
            if (Derecho != null)
            {
                aux2 = Derecho.CoordenadaX; //no hay nodo izquierdo, centrar en nodo derecho
                Derecho.CoordenadaX = CoordenadaX + 80; CoordenadaX = aux2;
            } else {
        ...
        public void DibujarNodo(Graphics grafo,Font fuente,Brush Relleno,Brush RellenoFuente,Pen Lapiz,Brush encuentro) {
            ...
            grafo.FillEllipse(encuentro, rect); grafo.FillEllipse(Relleno, rect);
            grafo.DrawEllipse(Lapiz, rect); // Para dibujar el nombre del nodo, es decir el contenido 
            StringFormat formato = new StringFormat();
            formato.Alignment =StringAlignment.Center;
            formato.LineAlignment =StringAlignment.Center;
            grafo.DrawString(info.ToString(), fuente, RellenoFuente, CoordenadaX,CoordenadaY, formato); //Dibuja los nodos hijos derecho e izquierdo.
            if (Izquierdo != null) {
